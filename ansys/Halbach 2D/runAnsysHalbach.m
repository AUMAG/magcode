function [] = runAnsysHalbach(a,b,N,h1,c,theta,angle,e,f,d,h2,g,h,mesh)
quote = '''';
fid1 = fopen('halbach2d.txt','wt');
fprintf(fid1,'/PREP7\n');
fprintf(fid1,'/TITLE, HALBACH CUBES\n');
%fprintf(fid1,'NERR,0,1e5\n');       % Neglect error messages
...
%     % non-guiding magnets
%     if cos((i-1)*theta)==1 || cos((i-1)*theta)==-1 || sin((i-1)*theta)==1 || sin((i-1)*theta)==-1
