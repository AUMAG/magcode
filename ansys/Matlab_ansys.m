...
x=0.4;         %distance between 2 magnets
...
mesh=0.005;     %meshsize numerical solution
...
%Displacement
displ=[0; 0; 1]*linspace(-.2,.2,100);

%calculate forces
forces=magnetforces(magnet_upper,magnet_lower,displ);
...
%print ansys batch code to text file
