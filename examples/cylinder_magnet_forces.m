...
coil_cyl_z = struct('turns',Nturns,'current',current,'dim',[r1 h1],'dir',[0 0 1]);
...
mag_cyl_z = struct('magn',J2,'dim',[r2 h2],'dir',[0 0 1]);
...
J2 = 1; % Tesla
mag_cuboid_z = struct('magn',J2,'dim',[x2 y2 h2],'magdir',[0 0 1]);
