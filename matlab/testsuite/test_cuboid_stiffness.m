...
%     function test_stiffness_cube(testCase,magdir1,magdir2,displ)
%                 
%       magnet_fixed = magnetdefine('type','cuboid','magn',1,'magdir',magdir1,'dim',[0.04  0.04  0.04]);
%       magnet_float = magnetdefine('type','cuboid','magn',1,'magdir',magdir2,'dim',[0.04  0.04  0.04]);
%       
%       incr = 1e-6;
%       xi = [incr;0;0];
%       yi = [0;incr;0];
