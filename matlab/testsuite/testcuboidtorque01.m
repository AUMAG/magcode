...
assert( all( round(1e6*T) == [0 33877 0] ), 'incorrect reference torques between parallel magnets' )
...
assert( all( round(1e6*T2) == [33877 0 0] ), 'incorrect reference torques between parallel magnets' )
...
assert( all( round(1e6*T3) == [0 0 33877] ), 'incorrect reference torques between parallel magnets' )
