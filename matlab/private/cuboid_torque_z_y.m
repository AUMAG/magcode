...
%                             );
              Ey(b) = 1/24*(...
                +  3*v(b).^3 ...
                -  r(b).*v(b).*( 12*Cu+10*u(b)+3*r(b)) ...
                + 2*v(b).*log(r(b)+u(b)).*(  3.*u(b).*(2*Cu+u(b)) + v2(b) - 3*w(b).*(4.*Cw+w(b)) ) ...
                + 2*v(b).*log(r(b)-u(b)).*( -3.*u(b).*(2*Cu+u(b)) + v2(b) ) ...
                              );
...
%                             );
              Ex(c) = ...
                + 1/12.*r(c).*( 2*r2(c) - 3.*Cw.*r(c) + 6.*Cv.*v(c) - 6.*Cw.*w(c) - 6.*w2(c) ) ...
                 + 1/2.*Cw.*(u2(c).*log(r(c)+w(c)) + v2(c).*log(r(c)-w(c)))...
                            ;
            ...
            if any(d)
              Ex(d) = (...
                  +1/12*r(d).*( 2*r2(d) + 6.*Cv.*v(d) - 6.*w2(d) - 6*Cw.*w(d) - 3*Cw.*r(d) ) ...
                  ...
                  -1/2*log(r(d)-u(d)).*u(d).*(2.*w(d).*Cw+r2(d)-u2(d)) ...
                  +1/2*log(r(d)-w(d)).*Cw.*(r2(d)-w2(d)) ...
                  ...
                  -    acoth(r(d)./u(d)).*u(d).*v(d).*(Cv+v(d)) ...
                  -1/2*acoth(r(d)./v(d)).*(Cv+v(d)).*(u2(d)-w2(d)) ...
                  +    acoth(r(d)./w(d)).*Cw.*u2(d) ...
                  ...
                  +u(d).*w(d).*Cv.*atan(u(d).*v(d)./(w(d).*r(d))) ...
                  -u(d).*v(d).*Cw.*atan(u(d).*w(d)./(v(d).*r(d)))...
                  ...
                  +u(d).*v(d).*w(d).*atan(u(d).*v(d)./(w(d).*r(d))) ...
                  -u(d).*v(d).*Cw.*atan(w(d)./r(d))...
                );
              Ey(d) = 1/72*(...
                - 10*u(d).^3 ...
...                +  9*v(d).^3 ...
...                -  6*u(d).*w(d).*(18*Cw+7*w(d)) ...
                -  3*r(d).*v(d).*( 12*Cu+10*u(d)+3*r(d)) ...
                ...
                - 72*u(d).*v(d).*Cw.*log(r(d)+w(d)) ...
...                - 72*u(d).*v(d).*Cw ...
                ...
                + 6*v(d).*log(r(d)+u(d)).*(  3.*u(d).*(2*Cu+u(d)) + v2(d) - 3*w(d).*(4.*Cw+w(d)) ) ...
                + 6*v(d).*log(r(d)-u(d)).*( -3.*u(d).*(2*Cu+u(d)) + v2(d) ) ...
                ...
                +  6*log(r(d)+v(d)).*( 2.*u(d).^3                 + 3*Cu.*(u2(d)-w2(d)) ) ...
                + 18*log(r(d)-v(d)).*( 2.*u(d).*w(d).*(2*Cw+w(d)) -   Cu.*(u2(d)-w2(d)) )...
                ...
...                + 24*w2(d).*(3.*Cw+w(d)).*atan(u(d)./w(d)) ...
...                + 36*Cw.*(u2(d)+w2(d)).*atan(w(d)./u(d)) ...
                +  3*v(d).^3.*Cw.*atan(u(d).*w(d)./(v(d).*r(d))) ...
                + 12*w(d).*( w2(d)+3.*Cw.*w(d) - 3.*u(d).*(2.*Cu+u(d)) ).*atan(u(d).*v(d)./(w(d).*r(d))) ...
                + 36*u2(d).*Cw.*atan((v(d).*w(d))./(u(d).*r(d)))...
                              );
              Ez(d) = 1/12.*(...
...                  + 1/3*w(d).^3 ...
...                  + 2.*w(d).*v2(d) ...
                  + r(d).*w(d).*(6.*Cu+u(d)) ...
...                  + 6.*u(d).*w(d).*(2.*Cu+u(d)) ...
                  + 6.*u(d).*w(d).*(2.*Cu+u(d)).*log(r(d)-u(d)) ...
