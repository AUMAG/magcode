...
%                             );
              Ey(b) = 1/24*(...
                ...
                + 2*v(b).*log(r(b)+u(b)).*(  3.*u(b).*(2*Cu(b)+u(b)) + v2(b) - 3*w(b).*(4.*Cw+w(b)) ) ...
...
%                             );
              ...
              Ez(c) = -1/12.*( 3*Cu(b) + 2*u(c) ).*u2(c).*log(u2(c));
            end
...
...                -  6*u(d).*w(d).*(18*Cw+7*w(d)) ...
                -  3*r(d).*v(d).*( 12*Cu(a)+10*u(d)+3*r(d)) ...
                ...
                - 72*u(d).*v(d).*Cw.*log(r(d)+w(d)) ...
...                - 72*u(d).*v(d).*Cw ...
                ...
                + 6*v(d).*log(r(d)+u(d)).*(  3.*u(d).*(2*Cu(d)+u(d)) + v2(d) - 3*w(d).*(4.*Cw+w(d)) ) ...
                + 6*v(d).*log(r(d)-u(d)).*( -3.*u(d).*(2*Cu(d)+u(d)) + v2(d) ) ...
                ...
                +  6*log(r(d)+v(d)).*( 2.*u(d).^3                 + 3*Cu(d).*(u2(d)-w2(d)) ) ...
                + 18*log(r(d)-v(d)).*( 2.*u(d).*w(d).*(2*Cw+w(d)) -   Cu(d).*(u2(d)-w2(d)) )...
                ...
                + 24*w2(d).*(3.*Cw+w(d)).*atan(u(d)./w(d)) ...
                + 36*Cw.*(u2(d)+w2(d)).*atan(w(d)./u(d)) ...
                +  3*v(d).^3.*Cw.*atan(u(d).*w(d)./(v(d).*r(d))) ...
                + 12*w(d).*( w2(d)+3.*Cw.*w(d) - 3.*u(d).*(2.*Cu(d)+u(d)) ).*atan(u(d).*v(d)./(w(d).*r(d))) ...
