          ...
          for nn=[0,1]
            ...
            if any(d)
              ...
              Ex(d) = 1/8.*(...
                ...
                ...
                + 4.*w(d).*(Cvv(d).*v(d)-w(d).*Cww(d)).*acoth(s(d)./v(d)) + ...
                + 4.*u(d).*(Cvv(d).*v(d)-w(d).*Cww(d)).*atan(u(d).*v(d)./(w(d).*s(d))) ...
                           );
              ...
              Ey(d) = 1/8*(...
                ...
                + 2.*w(d).*(Cww(d).*w(d)-u(d).*Cuu(d)).*log(s(d)+u(d)) + ...
                - 2.*w(d).*(Cww(d).*w(d)-u(d).*Cuu(d)).*log(s(d)-u(d)) + ...
                ...
                ...
                + 4.*v(d).*(Cww(d).*w(d)-u(d).*Cuu(d)).*atan(u(d).*v(d)./(w(d).*s(d))) ...
                         );
              ...
              Ez(d) = 1/36.*(...
                ...
                + 18.*Cu(d).*v(d).*s(d) + ...
                - 18.*u(d).*Cv(d).*s(d) ...
                + 18.*u(d).*v(d).*(Cvv(d)-2.*Cu(d)) + ...
                ...
                +  6.*w(d).*(w2(d)-3.*v(d).*Cvv(d)).*atan(u(d)./w(d)) + ...
                -  6.*w(d).*(w2(d)-3.*u(d).*Cuu(d)).*atan(v(d)./w(d)) + ...
                - 18.*(Cvv(d).*v(d)-u(d).*Cuu(d)).*w(d).*atan(u(d).*v(d)./(w(d).*s(d))) + ...
                ...
                + 18.*u(d).*v(d).*Cuu(d).*log(s(d)-u(d)) + ...
                - 18.*u(d).*v(d).*Cvv(d).*log(s(d)-v(d)) + ...
