          ...
          for nn=[0,1]
            ...
            if any(d)
              ...
              Ex(d) = 1/8.*(...
                ...
                ...
                + 4.*Cv(d).*u(d).*w(d).*log(s(d)+u(d)) + ...
                - 4.*Cv(d).*u(d).*w(d).*log(s(d)-u(d)) + ...
                - 8.*u(d).*v(d).*(Cw(d)+w(d)).*log(s(d)-u(d)) + ...
                ...
                + (4.*Cw(d)+2.*w(d)).*(s2(d)-v2(d)).*log(s(d)+v(d)) + ...
                ...
                + 4.*w(d).*(+v2(d)-w2(d)+2.*Cv(d).*v(d)-2.*w(d).*Cw(d)).*acoth(s(d)./v(d)) + ...
                + 4.*u(d).*(+v2(d)-w2(d)+2.*Cv(d).*v(d)-2.*w(d).*Cw(d)).*atan(u(d).*v(d)./(w(d).*s(d))) ...
                           );
              
              Ey(d) = 1/8*(...
                + (2.*Cw(d)+   w(d)).*s2(d) + ...
                + (4.*Cw(d)+6.*w(d)).*u(d).*s(d) + ...
                + 8.*Cu(d).*w(d).*s(d) ...
                ...
                - (4.*Cw(d)+2.*w(d)).*(s2(d)-u2(d)).*log(s(d)+u(d)) + ...
                + 2.*w(d).*(w2(d)+2.*Cw(d).*w(d)-u(d).*(2.*Cu(d)+u(d))).*log(s(d)+u(d)) + ...
                - 2.*w(d).*(w2(d)+2.*Cw(d).*w(d)-u(d).*(2.*Cu(d)+u(d))).*log(s(d)-u(d)) + ...
                ...
                + 8.*u(d).*v(d).*(Cw(d)+w(d)).*( log(s(d)-v(d)) - 1 ) + ...
                + 4.*Cu(d).*v(d).*w(d).*log(s(d)-v(d)) + ...
                - 4.*Cu(d).*v(d).*w(d).*log(s(d)+v(d)) + ...
                ...
                + 8.*v(d).*w(d).*(Cw(d)+w(d)).*atan(u(d)./w(d)) + ...
                + 4.*v(d).*(w2(d)+2.*Cw(d).*w(d)-u(d).*(2.*Cu(d)+u(d))).*atan(u(d).*v(d)./(w(d).*s(d))) ...
                         );
              ...
              Ez(d) = 1/36.*(...
                ...
                + 18.*Cu(d).*v(d).*s(d) + ...
                - 18.*u(d).*Cv(d).*s(d) ...
                + 18.*u(d).*v(d).*(2.*Cv(d)+v(d)-2.*Cu(d)) + ...
                ...
                +  6.*w(d).*(w2(d)-3.*v(d).*(2.*Cv(d)+v(d))).*atan(u(d)./w(d)) + ...
                -  6.*w(d).*(w2(d)-3.*u(d).*(2.*Cu(d)+u(d))).*atan(v(d)./w(d)) + ...
                - 18.*(v2(d)+2.*Cv(d).*v(d)-u(d).*(2.*Cu(d)+u(d))).*w(d).*atan(u(d).*v(d)./(w(d).*s(d))) + ...
                ...
                + 18.*u(d).*v(d).*(2.*Cu(d)+u(d)).*log(s(d)-u(d)) + ...
                - 18.*u(d).*v(d).*(2.*Cv(d)+v(d)).*log(s(d)-v(d)) + ...
                +  9.*(2.*Cv(d)+v(d)).*(v2(d)-w2(d)).*log(s(d)+u(d)) + ...
                -  9.*(2.*Cu(d)+u(d)).*(u2(d)-w2(d)).*log(s(d)+v(d)) ...
                            );
